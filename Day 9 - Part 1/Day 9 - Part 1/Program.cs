        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < AllValueStored.Count; i++)
            {
                ...
                while (true)
                {
                    ...
                    {
                        case 0:
                            total2 += temp[temp.Count - 1];
                            b--;
                            break;
                        case 1:
                            total2 += temp1[temp1.Count - 1];
                            b--;
                            break;
                        case 2:
                            total2 += temp2[temp2.Count - 1];
                            b--;
                            break;
                        case 3:
                            total2 += temp3[temp3.Count - 1];
                            b--;
                            break;
                        case 4:
                            total2 += temp4[temp4.Count - 1];
                            b--;
                            break;
                        case 5:
                            total2 += temp5[temp5.Count - 1];
                            b--;
                            break;
                        case 6:
                            total2 += temp6[temp6.Count - 1];
                            b--;
                            break;
                        case 7:
                            total2 += temp7[temp7.Count - 1];
                            b--;
                            break;
                        case 8:
                            total2 += temp8[temp8.Count - 1];
                            b--;
                            break;
                        case 9:
                            total2 += temp9[temp9.Count - 1];
                            b--;
                            break;
                        case 10:
                            total2 += temp10[temp10.Count - 1];
                            b--;
                            break;
                        case 11:
                            total2 += temp11[temp11.Count - 1];
                            b--;
                            break;
                        case 12:
                            total2 += temp12[temp12.Count - 1];
                            b--;
                            break;
                        case 13:
                            total2 += temp13[temp13.Count - 1];
                            b--;
                            break;
                        case 14:
                            total2 += temp14[temp14.Count - 1];
                            b--;
                            break;
                        case 15:
                            total2 += temp15[temp15.Count - 1];
                            b--;
                            break;
                        case 16:
                            total2 += temp16[temp16.Count - 1];
                            b--;
                            break;
                        case 17:
                            total2 += temp17[temp17.Count - 1];
                            b--;
                            break;
                        case 18:
                            total2 += temp18[temp18.Count - 1];
                            b--;
                            break;
                        case 19:
                            total2 += temp19[temp19.Count - 1];
                            b--;
                            break;
                        case 20:
                            total2 += temp20[temp20.Count - 1];
                            b--;
                            break;
                        case 21:
                            total2 += temp21[temp21.Count - 1];
                            b--;
                            break;
                        case 22:
                            total2 += temp22[temp22.Count - 1];
                            b--;
                            break;
